...
#
# Generated by Vivado on Fri Apr 03 21:23:01 EET 2026
...
#
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/transposed_block.v"
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/FIR_transposed.sv"
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_M_AXIS.sv"
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_S_AXI.sv"
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_S_AXIS.sv"
#    "/mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/xdma_demo.srcs/utils_1/imports/synth_1/bd_wrapper.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/../src/transposed_block.v"]"\
 "[file normalize "$origin_dir/../src/FIR_transposed.sv"]"\
 "[file normalize "$origin_dir/../src/my_fir_v1_0_M_AXIS.sv"]"\
 "[file normalize "$origin_dir/../src/my_fir_v1_0_S_AXI.sv"]"\
 "[file normalize "$origin_dir/../src/my_fir_v1_0_S_AXIS.sv"]"\
 "[file normalize "$origin_dir/../src/my_fir_v1_0.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/../src/transposed_block.v"
...
set file "$origin_dir/../src/FIR_transposed.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../src/my_fir_v1_0_M_AXIS.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../src/my_fir_v1_0_S_AXI.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../src/my_fir_v1_0_S_AXIS.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../src/my_fir_v1_0.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files transposed_block.v] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/transposed_block.v
}
if { [get_files FIR_transposed.sv] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/FIR_transposed.sv
}
if { [get_files my_fir_v1_0_M_AXIS.sv] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_M_AXIS.sv
}
if { [get_files my_fir_v1_0_S_AXI.sv] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_S_AXI.sv
}
if { [get_files my_fir_v1_0_S_AXIS.sv] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0_S_AXIS.sv
}
if { [get_files my_fir_v1_0.v] == "" } {
  import_files -quiet -fileset sources_1 /mnt/d_drive/Digital_Electronics/XDMA/xilinx_xdma_demo/src/my_fir_v1_0.v
}
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/xdma_demo.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/xdma_demo.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/xdma_demo.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
